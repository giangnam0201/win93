...
// jsfxr - 1.2.2 - https://github.com/chr15m/jsfxr
...
var hasRequiredRiffwave
var n

var _actx = null

function requireRiffwave() {
  if (hasRequiredRiffwave) return riffwave.exports
  hasRequiredRiffwave = 1
  ;(function (module) {
    var FastBase64 = {
      chars:
...
;(function (module) {
  ...
  SoundEffect.prototype.init = function (ps) {
    // Prevent BiquadFilterNode: state is bad
    ps.p_env_sustain = Math.max(0.01, ps.p_env_sustain)
    ps.p_env_decay = Math.max(0.01, ps.p_env_decay)
    ...
    return function () {
      ...
      if (actx) {
        var buff = actx.createBuffer(
          1,
          wave.buffer.length,
          actx.sampleRate, // wave.header.sampleRate,
        )
        var nowBuffering = buff.getChannelData(0)
  ...
  var units = {
    ...
    p_freq_dramp: function (v) {
      return (
        ((v * 44100) / Math.pow(2, -44101 / 44100)).toExponential(4) +
        " 8va/s^2"
      )
    },
...
var sfxrExports = sfxr$2.exports
var sfxr$1 = /*@__PURE__*/ getDefaultExportFromCjs(sfxrExports)

export { sfxr$1 as default }

export const sfxr = sfxr$1.sfxr
export const Params = sfxr$1.Params
export const SoundEffect = sfxr$1.SoundEffect
export const convert = sfxr$1.convert
export const parameters = sfxr$1.parameters
export const waveforms = sfxr$1.waveforms

export function initSfxr() {
