...
class DepthOfFieldNode extends TempNode {
  ...
  setup() {
    ...
    const dof = Fn(() => {
      ...
      const dofblur = vec2(
        clamp(
          factor.mul(this.apertureNode),
          this.maxblurNode.negate(),
          this.maxblurNode,
        ),
      )
      ...
      col = col.add(
        sampleTexture(
          uvNode.add(vec2(0.0, 0.4).mul(aspectcorrect).mul(dofblur)),
        ),
      )
      col = col.add(
        sampleTexture(
          uvNode.add(vec2(0.15, 0.37).mul(aspectcorrect).mul(dofblur)),
        ),
      )
      col = col.add(
        sampleTexture(
          uvNode.add(vec2(0.29, 0.29).mul(aspectcorrect).mul(dofblur)),
        ),
      )
      col = col.add(
        sampleTexture(
          uvNode.add(vec2(-0.37, 0.15).mul(aspectcorrect).mul(dofblur)),
        ),
      )
      col = col.add(
        sampleTexture(
          uvNode.add(vec2(0.4, 0.0).mul(aspectcorrect).mul(dofblur)),
        ),
      )
      col = col.add(
        sampleTexture(
      ...
      col = col.add(
        sampleTexture(
          uvNode.add(vec2(0.15, 0.37).mul(aspectcorrect).mul(dofblur9)),
        ),
      )
      col = col.add(
        sampleTexture(
          uvNode.add(vec2(-0.37, 0.15).mul(aspectcorrect).mul(dofblur9)),
        ),
      )
      col = col.add(
        sampleTexture(
      ...
      col = col.add(
        sampleTexture(
          uvNode.add(vec2(0.29, 0.29).mul(aspectcorrect).mul(dofblur7)),
        ),
      )
      col = col.add(
        sampleTexture(
          uvNode.add(vec2(0.4, 0.0).mul(aspectcorrect).mul(dofblur7)),
        ),
      )
      col = col.add(
        sampleTexture(
      ...
      col = col.add(
        sampleTexture(
          uvNode.add(vec2(0.0, -0.4).mul(aspectcorrect).mul(dofblur7)),
        ),
      )
      col = col.add(
        sampleTexture(
      ...
      col = col.add(
        sampleTexture(
          uvNode.add(vec2(0.29, 0.29).mul(aspectcorrect).mul(dofblur4)),
        ),
      )
      col = col.add(
        sampleTexture(
          uvNode.add(vec2(0.4, 0.0).mul(aspectcorrect).mul(dofblur4)),
        ),
      )
      col = col.add(
        sampleTexture(
      ...
      col = col.add(
        sampleTexture(
          uvNode.add(vec2(0.0, -0.4).mul(aspectcorrect).mul(dofblur4)),
        ),
      )
      col = col.add(
        sampleTexture(
