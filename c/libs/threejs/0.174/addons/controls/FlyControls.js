...
import { Controls, Quaternion, Vector3 } from "/c/libs/threejs/0.174/three.js"
...
class FlyControls extends Controls {
  ...
  _updateMovementVector() {
    const forward =
      this._moveState.forward || (this.autoForward && !this._moveState.back)
        ? 1
        : 0
  ...
  _updateRotationVector() {
    ...
    this._rotationVector.z =
      -this._moveState.rollRight + this._moveState.rollLeft
