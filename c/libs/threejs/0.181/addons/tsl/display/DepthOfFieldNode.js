...
class DepthOfFieldNode extends TempNode {
  ...
  setup(builder) {
    ...
    this._CoCBlurredMaterial.colorNode = gaussianBlur(
      this._CoCTextureNode,
      1,
      2,
    )
    ...
    this._blur64Material.fragmentNode = blur64().context(
    ...
    this._blur16Material.fragmentNode = blur16().context(
      builder.getSharedContext(),
    )
    ...
    this._compositeMaterial.fragmentNode = composite().context(
      builder.getSharedContext(),
    )
