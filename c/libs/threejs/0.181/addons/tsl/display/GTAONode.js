    ...
    const ao = Fn(() => {
      ...
      Loop(
        ...
        ({ i }) => {
          ...
          const sliceBitangent = normalize(
            cross(sampleDir.xyz, viewDir),
          ).toVar()
          ...
          const tangentToNormalInSlice = cross(
            normalInSlice,
            sliceBitangent,
          ).toVar()
          ...
          Loop(
            { end: STEPS, type: "int", name: "j", condition: "<" },
            ({ j }) => {
              ...
              const viewDeltaX = sampleSceneViewPositionX
                .sub(viewPosition)
                .toVar()
              ...
              const viewDeltaY = sampleSceneViewPositionY
                .sub(viewPosition)
                .toVar()
          ...
          const sinHorizons = sqrt(
            sub(1.0, cosHorizons.mul(cosHorizons)),
          ).toVar()
          ...
          const nxb = mul(
            ...
            acos(cosHorizons.y)
              ...
              .add(
                sinHorizons.x
                  .mul(cosHorizons.x)
                  .sub(sinHorizons.y.mul(cosHorizons.y)),
              ),
          )
          const nyb = mul(
            0.5,
