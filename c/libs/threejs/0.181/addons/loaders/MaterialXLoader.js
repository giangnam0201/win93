...
const MXElements = [
  ...
  new MXElement("ifgreatereq", mx_ifgreatereq, [
    "value1",
    "value2",
    "in1",
    "in2",
  ...
  new MXElement("heighttonormal", mx_heighttonormal, [
    "in",
    "scale",
    "texcoord",
  ]),
...
class MaterialXNode {
  ...
  setStandardSurfaceToGltfPBR(material) {
    ...
    if (inputs.specular_rotation)
      anisotropyRotationNode = inputs.specular_rotation
    ...
    if (inputs.transmission_color)
      transmissionColorNode = inputs.transmission_color
    ...
    if (inputs.thin_film_thickness)
      thinFilmThicknessNode = inputs.thin_film_thickness
    ...
    if (inputs.emissionColor) {
      emissiveNode = emissiveNode
        ? mul(emissiveNode, inputs.emissionColor)
        : emissiveNode
    }
    ...
    material.transmissionColorNode =
      transmissionColorNode || color(1.0, 1.0, 1.0)
