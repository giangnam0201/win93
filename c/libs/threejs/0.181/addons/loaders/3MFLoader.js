  ...
  parse(data) {
    ...
    function parseImplicitFunctionNode(implicitFunctionNode) {
      ...
      for (let i = 0; i < functionNodes.length; i++) {
        ...
        if (
          operatorNode.nodeName === "i:in" ||
          operatorNode.nodeName === "i:out"
        ) {
          ...
          for (let i = 0; i < inputNodes.length; i++) {
            portArguments[inputNodes[i].nodeName.substring(2)] =
              parseImplicitIONode(inputNodes[i])
          }
    ...
    function parseResourcesNode(resourcesNode) {
      ...
      const implicitFunctionNodes =
        resourcesNode.querySelectorAll("implicitfunction")
      ...
      for (let i = 0; i < implicitFunctionNodes.length; i++) {
        ...
        const implicitFunctionData =
          parseImplicitFunctionNode(implicitFunctionNode)
        resourcesData["implicitfunction"][implicitFunctionData["id"]] =
